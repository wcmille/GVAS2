...
namespace GVA.NPCControl.LimitedProduction
{
    ...
    public class LimitedProduction_SafeZoneBlock : LimitedProduction<IMySafeZoneBlock>
    {
        ...
        BoundingSphereD blackZone = new BoundingSphereD(SharedConstants.WorldCenter, offset + 400000.0);
        BoundingSphereD blueZone = new BoundingSphereD(new Vector3D(97825.9, 79558.68, 5725255.17), offset + 50000.0);
        BoundingSphereD redZone = new BoundingSphereD(new Vector3D(124468.67, 191328.8, 5742379.16), offset + 50000.0);
        BoundingSphereD whiteZone = new BoundingSphereD(new Vector3D(-1854042, 131072, 2421365), 200000.0);
        BoundingSphereD greenZone = new BoundingSphereD(new Vector3D(111869, 136079, 5673610), offset + 35000.0);
